...
class Compat293(BaseCompat):
  """Blender 2.93 (Eevee) compatibility layer.

  2.93 introduced CryptomatteV2 and Shader to RGB for Eevee,
  differentiating it from 2.80-2.92.
  """
