...
class BaseScene():
  ...
  cycles_samples = 64
  cycles_use_adaptive_sampling = True
  ...
  denoising_feature_strength = 0.25
  denoising_glossy_direct = False
  ...
  def set_cycles_settings(self):
    ...
    bpy.context.scene.cycles.use_adaptive_sampling = self.cycles_use_adaptive_sampling = True
  ...
  def set_render_settings(self):
    ...
    bpy.context.scene.view_layers['View Layer'].cycles.use_denoising = self.use_denoising
    bpy.context.scene.view_layers['View Layer'].cycles.denoising_radius = self.denoising_radius
    bpy.context.scene.view_layers['View Layer'].cycles.denoising_strength = self.denoising_strength
    bpy.context.scene.view_layers['View Layer'].cycles.denoising_feature_strength = self.denoising_feature_strength
    bpy.context.scene.view_layers['View Layer'].cycles.denoising_glossy_direct = self.denoising_glossy_direct
  ...
  def create_planes(self):
    ...
    bpy.context.active_object.hide_render = True
    bpy.context.active_object.hide_viewport = True
    bpy.context.active_object.cycles_visibility.glossy = False
  ...
  def create_shadow_layer(self):
    ...
    bpy.context.view_layer.name = "Shadow Layer"
    bpy.context.window.view_layer = bpy.context.scene.view_layers['Shadow Layer']
  ...
  def create_composite_nodes(self):
    ...
    renderlayers_node02.layer = "Shadow Layer"
