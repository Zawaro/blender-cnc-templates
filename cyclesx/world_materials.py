...
def RA2_World(world_texture_path, world_texture_name, suffix):
  ...
  background_node02 = bpy.context.scene.world.node_tree.nodes.new(
    "ShaderNodeBackground"
  )
  background_node02.inputs[0].default_value = (1, 1, 1, 1)
  background_node03 = bpy.context.scene.world.node_tree.nodes.new(
    "ShaderNodeBackground"
  )
  background_node03.inputs[0].default_value = (0, 0, 1, 1)
  background_node04 = bpy.context.scene.world.node_tree.nodes.new(
    "ShaderNodeBackground"
  )
  ...
  separate_rgb_node = bpy.context.scene.world.node_tree.nodes.new(
    "ShaderNodeSeparateRGB"
  )
  tex_sky_node = bpy.context.scene.world.node_tree.nodes.new("ShaderNodeTexSky")
  tex_sky_node.sun_size = 0
  tex_sky_node.sun_intensity = 0.05
  tex_sky_node.sun_elevation = 0.933751
  tex_sky_node.sun_rotation = 3.54302
  tex_sky_node.altitude = 20000
  tex_sky_node.air_density = 1
  tex_sky_node.dust_density = 0.05
  tex_sky_node.ozone_density = 0.05
  tex_noise_node = bpy.context.scene.world.node_tree.nodes.new("ShaderNodeTexNoise")
  tex_noise_node.inputs[2].default_value = 4
