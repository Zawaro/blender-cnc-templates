...
def generate_scripts():
  ...
  for render_type in render_types:
    for render_engine in render_engines:
      ...
      is_buildupEevee = "True" if render_type == "Buildup" and render_engine == "BLENDER_EEVEE_NEXT" else "False"
      is_shadowCycles = "True" if render_type == "Shadow" and render_engine == "CYCLES" else "False"
      is_shadowEevee = "True" if render_type == "Shadow" and render_engine == "BLENDER_EEVEE_NEXT" else "False"
      is_previewCycles = "True" if render_type == "Preview" and render_engine == "CYCLES" else "False"
      is_previewEevee = "True" if render_type == "Preview" and render_engine == "BLENDER_EEVEE_NEXT" else "False"
